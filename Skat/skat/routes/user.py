...
def create_skat_user():
    ...
    try:
        ...
        print(f"*** Error in routes/user/create_skat_user() ***: \n{e}")
...
def update_skat_user(id):
    ...
    Args:
        id (int): skat user ID taken from the route URL e.g. user/1
    ...
    try:
        ...
        print(f"*** Error in routes/user/update_skat_user() ***: \n{e}")
        return jsonify("Check spelling and data types of request body elements!"), 400 
    else:
        try:
            cur = get_db().cursor()            
...
def delete_skat_user(id):
    ...
    try:
        ...
        print(f"*** Error in routes/user/delete_skat_user() ***: \n{e}")
